...
INSERT INTO `categoria` (`precio_categoria`, `cant_personas`, `fecha_alta`, `fecha_baja`, `estado`, `foto`, `nombre`, `descripcion_breve`, `descripcion_larga`) VALUES(250, 2, '2023-11-22', NULL, 'Activo', 'suite-clasica-1.png', 'Suite Clásica', 'Hermosa suite decorada en estilo clásico, atención personalizada, mini bar de lujo y beneficios gastronómicos.', 'La Suite Clásica del Libertador Hotel y Spa es una belleza de suite con los mejores servicios de atención personalizada. Su decoración clásica con mobiliario Luis XV, cuadros de época y arañas de cristal le dan un ambiente del más alto estilo. Cuenta con un minibar exclusivo con vinos importados y champagne, late check-out según disponibilidad y una cena para dos en nuestro Restaurante Retro con selección de menú.');
INSERT INTO `categoria` (`precio_categoria`, `cant_personas`, `fecha_alta`, `fecha_baja`, `estado`, `foto`, `nombre`, `descripcion_breve`, `descripcion_larga`) VALUES(180, 2, '2023-11-22', NULL, 'Activo', 'habitacion-retro-1.png', 'Habitación Retro', 'Habitación temática vintage, con radio reloj antiguo, acceso a entretenimiento vintage y descuentos en tratamientos spa.', 'Nuestras Habitaciones Retro poseen una deliciosa decoración vintage que evoca décadas pasadas. Mobiliario de mediados de siglo, radio reloj de época, papel tapiz floral y lámparas art déco componen su encanto old school. Los huéspedes tienen acceso gratuito a nuestro Centro de Entretenimiento Antiguo con arcades, gramófono y películas en VHS. Además, obtienen un 10% de descuento en todos los tratamientos de nuestro Spa Vintage.');
